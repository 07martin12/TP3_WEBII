...
$router->addRoute('cancion/:id_artista/:id_cancion', 'PUT', 'CancionController', 'update');
$router->addRoute('cancion/:id_artista/:id_cancion', 'DELETE', 'CancionController', 'delete');
